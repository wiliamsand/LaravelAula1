...
class BoletimController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $messages = array(
            'registration.required' => 'É obrigatório indicar a matrícula do aluno',
            'name.required' => 'É obrigatório indicar o nome do aluno',
            'class.required' => 'É obrigatório indicar a disciplina',
        );
    ...
    public function update(Request $request, $id)
    {
        ...
        $obj_Boletim->user_id     = Auth::id();
        $obj_Boletim->save();
        return redirect('/boletim')->with('success', 'Boletim alterado com sucesso!!');
    }
    /**
    ...
    public function delete($id)
    {
        ...
        if( Auth::id() == $obj_Boletim->user_id ){
            ...
            //retorno para a rota /boletim com o erro
            return redirect('/boletim')->withErrors("Você não tem permissão para deletar este boletim");
        }
    }
    /**
